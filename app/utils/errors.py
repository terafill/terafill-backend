...
class InternalServerException(HTTPException):
    def __init__(self, status_code: int = status.HTTP_500_INTERNAL_SERVER_ERROR, message: Optional[str] = None, headers: Optional[dict] = None):
        if not message:
...
class EmailAlreadyRegisteredException(HTTPException):
    def __init__(self, status_code: int = status.HTTP_409_CONFLICT, message: Optional[str] = None, headers: Optional[dict] = None):
        if not message:
...
class InvalidVerificationCodeException(HTTPException):
    def __init__(self, status_code: int = status.HTTP_400_BAD_REQUEST, message: Optional[str] = None, headers: Optional[dict] = None):
        if not message:
...
class EmailDeactivatedException(HTTPException):
    def __init__(self, status_code: int = status.HTTP_401_UNAUTHORIZED, message: Optional[str] = None, headers: Optional[dict] = None):
        if not message:
